...
internal static class TypeExtensions
{
    ...
    public static DuckDBLogicalType GetLogicalType(this Type type)
    {
        ...
        {
            return NativeMethods.NativeMethods.LogicalType.DuckDBCreateDecimalType(38, 18);
        }

        if (ClrToDuckDBTypeMap.TryGetValue(type, out var duckDBType))
        {
            return NativeMethods.NativeMethods.LogicalType.DuckDBCreateLogicalType(duckDBType);
        }

...
public class DuckDBLogicalType() : SafeHandleZeroOrMinusOneIsInvalid(true)
{
    ...
    {
        NativeMethods.LogicalType.DuckDBDestroyLogicalType(handle);
        return true;
    }
}
...
public class DuckDBDataChunk : SafeHandleZeroOrMinusOneIsInvalid
{
    ...
    {
        NativeMethods.DataChunks.DuckDBDestroyDataChunk(handle);
        return true;
    }
}
...
public class DuckDBValue : SafeHandleZeroOrMinusOneIsInvalid, IDuckDBValueReader
{
    ...
    protected override bool ReleaseHandle()
    {
        ...
        NativeMethods.Value.DuckDBDestroyValue(handle);
        return true;
    }
